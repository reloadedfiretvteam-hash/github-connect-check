      ...
      <header className="bg-slate-800/50 border-b border-slate-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-white">
            <span className="text-orange-500">Stream Stick Pro</span> Admin
          </h1>
          <Button 
            variant="ghost" 
      ...
      <main className="p-6">
        <Tabs defaultValue="products" className="space-y-6">
          <TabsList className="bg-slate-800/50 border border-slate-700 p-1 flex-wrap">
            ...
            <TabsTrigger value="blogs" className="data-[state=active]:bg-orange-500">
              <FileText className="w-4 h-4 mr-2" />
              SEO Blogs
            </TabsTrigger>
            <TabsTrigger value="visitors" className="data-[state=active]:bg-orange-500">
