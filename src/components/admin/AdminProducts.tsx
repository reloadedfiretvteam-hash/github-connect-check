  ...
  return (
    <div className="space-y-6">
          ...
          <DialogContent className="bg-slate-800 border-slate-700 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Select value={formData.type} onValueChange={(v) => setFormData(prev => ({ ...prev, type: v }))}>
                    ...
                    <SelectContent>
                      <SelectItem value="firestick">Fire Stick</SelectItem>
                ...
                <div>
                  ...
                  <Select value={formData.page} onValueChange={(v) => setFormData(prev => ({ ...prev, page: v }))}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="secure">Secure Domain</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <Label>Period (for subscriptions)</Label>
                  <Input
      ...
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader>
          <CardTitle className="text-white">Main Page Products</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            <table className="w-full text-sm text-left text-slate-300">
              ...
              <tbody>
                  ...
                  <tr key={product.id} className="border-b border-slate-700 hover:bg-slate-700/30">
                    <td className="px-4 py-3">
                      {product.image_url ? (
                        ...
                        <div className="w-12 h-12 bg-slate-600 rounded flex items-center justify-center text-xs">No img</div>
                      )}
                    </td>
                    <td className="px-4 py-3 font-medium text-white">{product.name}</td>
                    <td className="px-4 py-3 capitalize">{product.type}</td>
                    <td className="px-4 py-3 text-orange-400">${product.price}</td>
                ...
                {mainProducts.length === 0 && (
                  <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-500">No main page products yet</td></tr>
                )}
              </tbody>
            </table>
          </div>
      ...
      {/* Secure Domain Products */}
      <Card className="bg-slate-800/50 border-slate-700">
        <CardHeader>
          <CardTitle className="text-white">Secure Domain Products</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-slate-300">
              ...
              <tbody>
                ...
                {secureProducts.length === 0 && (
                  <tr><td colSpan={7} className="px-4 py-8 text-center text-slate-500">No secure domain products yet</td></tr>
                )}
              </tbody>
            </table>
          </div>
